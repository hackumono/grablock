...
printf "${RED}"
printf "${GREEN}"
print_centered "GRABLOCK v7.0"
printf "${BLUE}"
print_centered "EvilDevill"
printf "${RED}"
...
payload_ngrok() {
url=$redirect #"https://www.youtube.com/channel/UC0bX56PZ_nMZw3t4p90SYyQ"
...
default_redirect="https://www.youtube.com/channel/UC0bX56PZ_nMZw3t4p90SYyQ"
